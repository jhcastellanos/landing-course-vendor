...
// Production database
var connectionString = "Host=ep-holy-rain-ahk105a2-pooler.c-3.us-east-1.aws.neon.tech;Database=neondb;Username=neondb_owner;Password=npg_J8VQp6MkdlDi;SSL Mode=Require";
...
try
{
    ...
    Console.WriteLine("✅ Tables created: courses, customers, purchases");
    Console.WriteLine("✅ Sample data inserted: 4 courses");
}
catch (Exception ex)
{
